 ...
 * generated in the springboot.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetCurrentDate_QNAME = new QName("http://service.springboot/", "getCurrentDate");
    private final static QName _GetCurrentDateResponse_QNAME = new QName("http://service.springboot/", "getCurrentDateResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: springboot.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.springboot/", name = "getCurrentDate")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.springboot/", name = "getCurrentDateResponse")
